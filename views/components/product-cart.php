...
<div class="col-md-3">
                <div class="card">
                    ...
                    <img src="<?php echo BASE_URL. $product["image_url"]; ?>" class="card-img-top mx-auto" alt="Product Image" style="height:300px;width:300px"></a>
                    <div class="card-body text-center">
                        ...
                        <button href="#" class="btn btn-success" <?php echo ($product["stocks"] <= 0 ? "disabled" : ""); ?>>
                            <?php echo ($product["stocks"] <= 0 ? "Sold out" : "Add to cart");?></button>
                        </form>
                    </div>
                </div>
            </div>
